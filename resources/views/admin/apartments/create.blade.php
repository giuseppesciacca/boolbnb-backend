    ...
    <div class="container">
        ...
        <form action="{{route('admin.apartments.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="rooms" id="rooms" class="form-control @error('rooms') is-invalid @enderror" placeholder="N. Apartment rooms here " aria-describedby="imageHelper">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="bathrooms" id="bathrooms" class="form-control @error('bathrooms') is-invalid @enderror" placeholder="N. bathrooms here " aria-describedby="imageHelper">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="beds" id="beds" class="form-control @error('beds') is-invalid @enderror" placeholder="N. beds here " aria-describedby="imageHelper">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="square_meters" id="square_meters" class="form-control @error('square_meters') is-invalid @enderror" placeholder="N. square_meters here " aria-describedby="imageHelper">
                <small>MQ</small>
