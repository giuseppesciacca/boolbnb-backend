        ...
        <div class="row justify-content-center">
            <div class="col-md-8 my-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="custom-form" method="POST" action="{{ route('register') }}">
                            @csrf
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span id="span-name" class="d-none bg-danger text-dark" role="alert">
                                        <strong>Il nome deve essere compreso tra 3 e 50 caratteri</strong>
                                    </span>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span id="span-surname" class="d-none bg-danger text-dark" role="alert">
                                        <strong>Il cognome deve essere compreso tra 3 e 50 caratteri</strong>
                                    </span>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span id="span-date-of-birth" class="d-none bg-danger text-dark" role="alert">
                                        <strong>La data di nascita deve essere almeno antecedente a quella attuale</strong>
                                    </span>
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span id="span-password-confirm" class="d-none bg-danger text-dark" role="alert">
