                ...
                <div class="row">
                    <div class="col-6 col-lg-2 d-lg-flex align-items-center justify-content-center align-items-center mx-auto mb-4 mb-lg-0">
                        <ul class="w-100 mb-0 list-unstyled d-lg-flex flex-column justify-content-center align-items-center gap-3">
                            <li class="p-3 w-100 rounded-3 btn-1 btn-1-green {{ Route::currentRouteName() === 'admin.dashboard' ? 'bg-danger fst-italic fw-bolder' : 'bg-dark' }}">
                                <a class="text-light fw-bold text-decoration-none" href="{{ route('admin.dashboard') }}">Dashboard</a>
                                <i class="fa-solid fa-chalkboard-user"></i>
                            </li>
                            <li class="p-3 w-100 rounded-3 btn-1 btn-1-red {{ str_starts_with(Route::currentRouteName(), 'admin.apartments') ? 'bg-danger fst-italic fw-bolder' : 'bg-dark' }}">
                                <a class="text-light fw-bold text-decoration-none" href="{{ route('admin.apartments.index') }}">Appartamenti</a>
                            </li>
                            <li class="p-3 w-100 rounded-3 btn-1 btn-1-blue {{ str_starts_with(Route::currentRouteName(), 'admin.messages') ? 'bg-danger fst-italic fw-bolder' : 'bg-dark' }}">
                                <a class="text-light fw-bold text-decoration-none" href="{{ route('admin.messages.index') }}">Messaggi</a>
                            </li>
                            <li class="p-3 w-100 rounded-3 btn-1 btn-1-orange {{ str_starts_with(Route::currentRouteName(), 'admin.sponsors') ? 'bg-danger fst-italic fw-bolder' : 'bg-dark' }}">
